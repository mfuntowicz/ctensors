...
/// @return
static inline struct safetensors_table *safetensors_table_init() { return malloc(sizeof(struct safetensors_table)); }

/// Free a previously head-allocated safetensors metadata table
/// @param table
static inline void safetensors_table_free(struct safetensors_table *table)
{
